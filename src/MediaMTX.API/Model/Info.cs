...
namespace MediaMTX.API.Model
{
    ...
    public partial class Info : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Info(Option<string> started = default, Option<string> varVersion = default)
        {
        ...
        public Option<string> StartedOption { get; private set; }

        /// <summary>
        /// Gets or Sets Started
        /// </summary>
        [JsonPropertyName("started")]
        public string Started { get { return this.StartedOption; } set { this.StartedOption = new Option<string>(value); } }
    ...
    public class InfoJsonConverter : JsonConverter<Info>
    {
        ...
        public override Info Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (started.IsSet && started.Value == null)
                throw new ArgumentNullException(nameof(started), "Property is not nullable for class Info.");

            if (varVersion.IsSet && varVersion.Value == null)
                throw new ArgumentNullException(nameof(varVersion), "Property is not nullable for class Info.");

            return new Info(started, varVersion);
        }
        ...
        {
            if (info.StartedOption.IsSet && info.Started == null)
                throw new ArgumentNullException(nameof(info.Started), "Property is required for class Info.");

            if (info.VarVersionOption.IsSet && info.VarVersion == null)
                throw new ArgumentNullException(nameof(info.VarVersion), "Property is required for class Info.");

            if (info.StartedOption.IsSet)
                writer.WriteString("started", info.Started);

            if (info.VarVersionOption.IsSet)
